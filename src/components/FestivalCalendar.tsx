...
// Sample festival data with dates for 2024-2025
const festivalDays: FestivalDays = {
  '2024-10-12': {
    name: 'Navratri',
    image: require('../assets/festivals/navratri.jpg'),
    description: 'Nine nights of dance, devotion, and celebration',
    color: '#FF6B6B',
  },
  '2024-10-31': {
    name: 'Diwali',
    image: require('../assets/festivals/diwali.jpg'),
    description: 'Festival of lights and prosperity',
    color: '#FFD93D',
  },
  '2024-11-15': {
    name: 'Kartik Purnima',
    image: require('../assets/festivals/kartik-purnima.jpg'),
    description: 'Sacred full moon celebration',
    color: '#6BCF7F',
  },
  '2024-12-25': {
    name: 'Christmas',
    image: require('../assets/festivals/christmas.jpg'),
    description: 'Celebration of joy and giving',
    color: '#4ECDC4',
  },
  '2025-01-14': {
    name: 'Makar Sankranti',
    image: require('../assets/festivals/makar-sankranti.jpg'),
    description: 'Harvest festival and kite flying',
    color: '#45B7D1',
  },
  '2025-02-14': {
    name: 'Valentine\'s Day',
    image: require('../assets/festivals/valentine.jpg'),
    description: 'Day of love and romance',
    color: '#FF9FF3',
  },
  '2025-03-10': {
    name: 'Holi',
    image: require('../assets/festivals/holi.jpg'),
    description: 'Festival of colors and joy',
    color: '#FF6B9D',
  },
  '2025-04-14': {
    name: 'Baisakhi',
    image: require('../assets/festivals/baisakhi.jpg'),
