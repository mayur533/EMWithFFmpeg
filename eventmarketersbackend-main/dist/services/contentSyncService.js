...
exports.ContentSyncService = void 0;
...
class ContentSyncService {
     ...
     */
    static async syncSpecificImage(imageId) {
        try {
     ...
     */
    static async syncSpecificVideo(videoId) {
        try {
    ...
    static async getSyncStatus() {
        try {
            const [totalImages, syncedImages, pendingImages, totalVideos, syncedVideos, pendingVideos, totalTemplates, totalMobileVideos] = await Promise.all([
                prisma.image.count(),
    ...
    static mapImageCategoryToTemplateCategory(category) {
        switch (category) {
    ...
    static mapImageCategoryToTemplateType(category) {
        switch (category) {
            case 'BUSINESS': return 'business';
            case 'FESTIVAL': return 'festival';
    ...
    static mapVideoCategoryToVideoCategory(category) {
        switch (category) {
            case 'BUSINESS': return 'business';
            case 'FESTIVAL': return 'festival';
            case 'GENERAL': return 'general';
    ...
    static mapVideoCategoryToVideoType(category) {
        switch (category) {
...
exports.ContentSyncService = ContentSyncService;
exports.default = ContentSyncService;
//# sourceMappingURL=contentSyncService.js.map