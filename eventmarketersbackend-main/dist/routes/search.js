...
router.get('/images', [
    ...
    (0, express_validator_1.query)('businessCategoryId').optional().isString().withMessage('Business category ID must be a string'),
    ...
    (0, express_validator_1.query)('uploaderType').optional().isIn(['ADMIN', 'SUBADMIN']).withMessage('Invalid uploader type'),
    ...
    try {
        ...
        const { q, category, businessCategoryId, tags, approvalStatus, uploaderType, sortBy = 'createdAt', sortOrder = 'desc', page = 1, limit = 20 } = req.query;
        // Build where clause
        const where = {};
        // Text search
        if (q) {
...
router.get('/content', [
    ...
    try {
        ...
        const { q, category, businessCategoryId, tags, approvalStatus, uploaderType, contentType = 'all', sortBy = 'createdAt', sortOrder = 'desc', page = 1, limit = 20 } = req.query;
